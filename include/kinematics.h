...
class Kinematics {
    public:
        Kinematics(S_U_V s_u_v, double tendon_distance, uint16_t update_time);
        Kinematics(S_K_Phi s_k_phi, double tendon_distance, uint16_t update_time);
        ...
        void set_parameters(S_U_V parameters, double duration);
        void set_parameters(S_K_Phi parameters, double duration);
        void update();
    private:
